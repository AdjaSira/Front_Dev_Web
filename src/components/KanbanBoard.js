...
const initialProjects = {
  ...
  "project-3": {
    ...
    data: {
      tasks: {
        "task-1": { id: "task-1", content: "grave daccord ", description: "Description de la tâche Fatigue", priority: "Normal" },
        "task-2": { id: "task-2", content: "TAight", description: "Description de la tâche Epuise", priority: "Important" },
      },
      columns: {
        "column-1": { id: "column-1", title: "Il fait tard", taskIds: ["task-1", "task-2"] },
        "column-2": { id: "column-2", title: "Allons nous coucher", taskIds: [] },
      },
      columnOrder: ["column-1", "column-2"],
    }
  },
